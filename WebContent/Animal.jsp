...
<body>
	...
	<%
		...
		String id = request.getParameter("id"); // on recup la valeur du champs du formulaire avec name="id"
		if (id == null) {
	...
	<br />
	<br />
	<input type="submit" class="btn-back" value="Back" onclick="window.location='person.jsp';"/>
																						<!-- BACK BUTTON -->
